...
def image_pattern_solution(analyzed_image, coefficient, fill_strategy, size):
...
image_name = "serif2_to_repair.png"
start_size = 60
image_pattern_solution(repair_image(image_name), 0.94, fill_frame, start_size)
